...
public sealed class Machine : AuditableEntity<Guid>, IAggregateRoot
{
    ...
    private Machine() : base(Guid.Empty)
    {
    }
    ...
    /// </summary>
    public void GenerateApiToken(Guid? updatedBy = null)
    {
    ...
    /// </summary>
    public void RegenerateApiToken(string reason, Guid? updatedBy = null)
    {
    ...
    /// </summary>
    public void UpdateStatus(MachineStatus newStatus, string reason, Guid? updatedBy = null)
    {
        if (string.IsNullOrWhiteSpace(reason))
    ...
    /// </summary>
    public void ScheduleMaintenance(DateOnly date, MaintenanceInterval? interval = null, Guid? updatedBy = null)
    {
    ...
    /// </summary>
    public void CompleteMaintenance(DateOnly completedDate, MaintenanceInterval? interval = null, Guid? updatedBy = null)
    {
    ...
    /// </summary>
    public void ActivateAlarm(string reason, Guid? updatedBy = null)
    {
        if (string.IsNullOrWhiteSpace(reason))
    ...
    /// </summary>
    public void ClearAlarm(string reason, Guid? updatedBy = null)
    {
        if (string.IsNullOrWhiteSpace(reason))
