...
namespace Flowertrack.Infrastructure.Migrations
{
    ...
    [Migration("20251210170541_MakeOrganizationEmailNullable")]
    partial class MakeOrganizationEmailNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowertrack.Domain.Entities.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Flowertrack.Domain.Entities.MachineLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateTimeOffset?>("MachineTimestamp")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.ToTable("machine_logs", (string)null);
                });
            ...
            modelBuilder.Entity("Flowertrack.Domain.Entities.MachineLog", b =>
                {
                    b.HasOne("Flowertrack.Domain.Entities.Machine", "Machine")
                        .WithMany()
                        .HasForeignKey("MachineId")
