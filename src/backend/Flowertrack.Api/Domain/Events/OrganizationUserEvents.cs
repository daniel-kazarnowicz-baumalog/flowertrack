...
/// </summary>
public class OrganizationUserCreatedEvent : DomainEventBase
{
...
/// </summary>
public class OrganizationUserActivatedEvent : DomainEventBase
{
    public Guid UserId { get; }
...
/// </summary>
public class OrganizationUserDeactivatedEvent : DomainEventBase
{
    public Guid UserId { get; }
...
/// </summary>
public class OrganizationUserRoleChangedEvent : DomainEventBase
{
    public Guid UserId { get; }
