 ...
 * Detects all mock token types:
 * - mock-dev-token-* (from AuthContext.mockLogin)
 * - mock-service-token-* (from authService.mockServiceLogin)
 * - mock-client-token-* (from authService.mockClientLogin)
 */
export function isMockSession(): boolean {
  ...
  return (
    ...
    token.startsWith('mock-service-token-') ||
    token.startsWith('mock-client-token-')
  );
}
    ...
    items: [
      {
        ...
        machineModel: 'PT-100',
        machineSerialNumber: 'SN-PT100-001',
        assignedToId: 'user-1',
      ...
      },
      {
        ...
        machineModel: 'PK-200',
        machineSerialNumber: 'SN-PK200-001',
        assignedToId: null,
        assignedToName: null,
        createdById: 'user-client-1',
        createdByName: 'Maria Operator',
      ...
      },
      {
        ...
        machineModel: 'RS-500',
        machineSerialNumber: 'SN-RS500-001',
        assignedToId: 'user-2',
