        ...
        <>
            ...
            <aside className={`sidebar ${isOpen ? 'open' : ''} ${isCollapsed ? 'collapsed' : ''}`}>
                    ...
                    <nav className="sidebar__nav">
                        {sections.map((section, idx) => (
                            <div key={idx} className="sidebar__section">
                                {(section.title && !isCollapsed) && <h3 className="sidebar__sectionTitle">{section.title}</h3>}
                ...
                <div className="sidebar__footer">
                    ...
                    {!isCollapsed && (
                        <button onClick={handleLogout} className="sidebar__logoutBtn" title={t('auth.logout', 'Wyloguj')}>
                            ↪
                        </button>
                    )}
                </div>
